...
st.title("TEXT SHIELD AI : AI Plagiarism Tool Detector")
    ...
    if st.button("Analyze"):
        ...
        with col2:
            ...
            if perplexity > 30000 and burstiness_score < 0.2:
                st.error("Text Analysis Result: Content Generated by AI")
            else:
                st.success("Text Analysis Result: Content Not Generated by AI")
                
            st.warning("Disclaimer: AI Plagiarism detector apps can assist in identifying potential instances of plagiarism. However it is important to note that their results are not fully accurate. Please use this information with responsibility and don't make the decision based on this tool completely.")
